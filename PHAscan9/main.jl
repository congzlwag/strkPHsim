...
const hvX_eV_ = [68.0]; #collect(0:-0.2:-2)[1:end-1] .+ 42.8; # central photon energies of the gaussian pulses
...
config["Kmax"] = STRK ? 2.7^2/2 : 2.3^2/2;  # in a.u.
config["Kmin"] = 1.7 #1.6^2/2; # 0.32; # in a.u.
config["Ip"] = Ip1;
config["tauX"] = tauX;
